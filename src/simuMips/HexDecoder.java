...
public class HexDecoder {
	...
	//constructor
	//quando uma instancia da classe for criada o banco de registradores � iniciado
	public HexDecoder() {
	...
	public String decoderInstruction(String hex) {
		...
		if(util.getOpcode(bin).equalsIgnoreCase("000000")) {
			...
			case "100000": //add rd, rs, rt
				...
				//-------------------------------------------------------------------------------------------------------------//
				//pegando os valores da instru��o
		...
		case "000101": // bne rs, rt, start // CONSERTAR START PELA INSTRUÇÃO
